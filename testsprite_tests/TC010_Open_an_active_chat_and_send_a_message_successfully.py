...
async def run_test():
    ...
    try:
        ...
        # -> Type the provided email and password into the login inputs and click the 'Entrar na Plataforma' button to sign in.
        ...
        frame = context.pages[-1]
        await expect(frame.locator('text=Olá, teste de envio').first).to_be_visible(timeout=3000)
