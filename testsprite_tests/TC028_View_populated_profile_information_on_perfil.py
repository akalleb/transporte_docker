...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields with the provided credentials and click the 'Entrar na Plataforma' button to log in.
        ...
        frame = context.pages[-1]
        assert '/' in frame.url
        assert '/perfil' in frame.url
        await expect(frame.locator('text=Nome').first).to_be_visible(timeout=3000)
