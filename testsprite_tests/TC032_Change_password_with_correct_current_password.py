...
async def run_test():
    ...
    try:
        ...
        # -> Type the username into the E-mail field (index 6) and the password into the Senha field (index 7), then click the Entrar na Plataforma button (index 12).
        ...
        # -> Type the username into E-mail (index 254), type the password into Senha (index 255), then click Entrar (index 260).
        frame = context.pages[-1]
        # Input text
        elem = frame.locator('xpath=/html/body/div[1]/div/div[2]/div[2]/form/div[1]/div/input').nth(0)
        await page.wait_for_timeout(3000); await elem.fill('arthurkalleb@protonmail.com')
