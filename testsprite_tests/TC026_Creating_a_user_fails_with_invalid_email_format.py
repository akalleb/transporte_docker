...
async def run_test():
    ...
    try:
        ...
        # -> Type the provided username into the E-mail field, type the provided password into the Senha field, then click the 'Entrar na Plataforma' button to sign in.
        ...
        frame = context.pages[-1]
        await expect(frame.locator('text=email inválido').first).to_be_visible(timeout=3000)
