...
async def run_test():
    ...
    try:
        ...
        # -> Type the provided credentials into the email and password fields and click the 'Entrar na Plataforma' button.
        ...
        # -> Click the 'Entrar na Plataforma' submit button to (re)submit the login form so the app can render the main UI.
        frame = context.pages[-1]
        # Click element
