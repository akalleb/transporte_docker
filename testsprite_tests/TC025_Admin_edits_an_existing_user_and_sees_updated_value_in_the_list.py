...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email field with the provided username, fill the password field, then click the 'Entrar na Plataforma' button.
        ...
        # -> Retry clicking the 'Entrar na Plataforma' button to attempt login again, then wait for the application to load and for the 'Configurações' menu item to appear.
        frame = context.pages[-1]
        # Click element
        ...
        frame = context.pages[-1]
        await expect(frame.locator('text=Editado').first).to_be_visible(timeout=3000)
