...
async def run_test():
    ...
    try:
        ...
        # -> Type the username into the E-mail input field (index 8) and then type the password into the password input (index 9), then click the 'Entrar na Plataforma' button (index 14).
        ...
        frame = context.pages[-1]
        await expect(frame.locator('text=Salvo').first).to_be_visible(timeout=3000)
