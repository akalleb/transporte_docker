...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields and click the 'Entrar na Plataforma' (login) button
        ...
        # -> Attempt login again by filling the email and password fields and clicking the 'Entrar na Plataforma' button.
        frame = context.pages[-1]
        # Input text
        ...
        frame = context.pages[-1]
        assert '/atendimento' in frame.url
        await expect(frame.locator('text=Nenhuma conversa').first).to_be_visible(timeout=3000)
