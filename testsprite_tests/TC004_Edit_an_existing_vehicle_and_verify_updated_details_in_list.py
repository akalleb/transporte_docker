...
async def run_test():
    ...
    try:
        ...
        # -> Type the provided email into the E-mail field, type the provided password into the Senha field, then click the 'Entrar na Plataforma' button to log in.
        ...
        await expect(frame.locator('text=Modelo Editado').first).to_be_visible(timeout=3000)
