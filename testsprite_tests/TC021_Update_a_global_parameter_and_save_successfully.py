...
async def run_test():
    ...
    try:
        ...
        # -> Enter the provided credentials into the email and password fields and click the 'Entrar na Plataforma' button.
        ...
        await expect(frame.locator('text=Salvo com sucesso').first).to_be_visible(timeout=3000)
